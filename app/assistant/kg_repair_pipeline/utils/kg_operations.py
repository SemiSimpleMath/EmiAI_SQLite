...
class KGOperations:
    ...
    def backup_kg_state(self, backup_name: str) -> bool:
        ...
        """
        try:
            logger.info(f"💾 Creating KG backup: {backup_name}")
            ...
            logger.error(f"❌ Failed to create KG backup: {e}")
            return False
    ...
    def restore_kg_state(self, backup_name: str) -> bool:
        ...
        """
        try:
            logger.info(f"🔄 Restoring KG from backup: {backup_name}")
            ...
            logger.error(f"❌ Failed to restore KG from backup: {e}")
            return False
