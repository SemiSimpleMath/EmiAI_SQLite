...
from app.assistant.physical_status_manager.manager import BaseStage, StageContext, StageResult
...
class AgentStage(BaseStage):
    ...
    Stage config example:
    {
      "id": "health_inference",
      "enabled": true,
      "stage_class": "app.assistant.physical_status_manager.stages.agent_stage:AgentStage",
