# app/assistant/day_flow_manager/sleep/sleep_reconciler.py
"""
Sleep Reconciler
...
def _intersect_with_union(intervals: List[Interval], bounds: List[Interval]) -> List[Interval]:
    """
    Keep only portions of `intervals` that overlap the union of `bounds`.
    Useful to keep wake interruptions only where they actually happen during sleep.
    """
    ...
    Returns:
      {
        ...
        "wake_interruptions": [ {start,end,duration_minutes,notes,estimated} ... ],
        "fragmented": bool,
